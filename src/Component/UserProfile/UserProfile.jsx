...
const UserProfile = () => {
    return (
        <section className='flex flex-col bg-white w-full drop-shadow-lg rounded-lg'>
            ...
            <div className='h-24  bg-blue-600 w-full rounded-t-lg'></div>
            <div className='bg-white -mt-7 self-center rounded-full'>
                <img src="https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8dXNlciUyMHByb2ZpbGV8ZW58MHx8MHx8&w=1000&q=80" className='h-20 rounded-full p-1' alt="" />
            </div>
            ...
            <div className=' mx-3'>
                ...
                <div className='text-center my-4 mx-5'>
                    ...
                    <div className='flex gap-3 text-center items-center justify-center my-5'>
                        ...
                        <p className='text-sm font-semibold text-gray-400'>From previous period</p>
                    </div>
                    <div className="divider mb-0"></div>
                </div>
